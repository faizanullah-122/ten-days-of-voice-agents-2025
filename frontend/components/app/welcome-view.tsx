  ...
  ({ startButtonText, onStartCall }, ref) => {
    ...
    return (
      ...
      >
        ...
        {/* ---------------------------------------------- */}
        {/* LEFT SIDE TITLE (YOUR CUSTOM TEXT) */}
        {/* ---------------------------------------------- */}
        <div className="absolute left-6 md:left-12 top-1/2 -translate-y-1/2 
        text-4xl md:text-5xl font-extrabold tracking-widest 
        text-white/90 drop-shadow-[0_0_15px_rgba(255,255,255,0.6)]
        uppercase select-none pointer-events-none">
          VOICE<br/>IMPROV<br/>BATTLE
        </div>
